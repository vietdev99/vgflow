...
metadata:
  short-description: "VPS sandbox testing gate — deploy, unit/API via CLI agents, E2E via MCP Playwright (visible browser), auto-fix loop max 3 iterations"
---
...
Invoke this skill as `$sandbox-test`. Treat all user text after the skill name as arguments.
</codex_skill_adapter>
