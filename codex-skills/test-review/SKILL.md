...
metadata:
  short-description: "Review TEST-SPEC with adversarial self-review, historical gap patterns, coverage gate, API contract audit, CrossAI verification"
---
...
Invoke this skill as `$test-review`. Treat all user text after the skill name as arguments.
</codex_skill_adapter>
