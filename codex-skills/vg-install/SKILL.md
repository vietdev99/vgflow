...
metadata:
  short-description: "First-run / re-install / switch / repair the VG harness install target (global ~/.vgflow/ vs project .claude/) — wires hooks + writes .vg/.install-target marker."
---
...
Invoke this skill as `$vg-install`. Treat all user text after the skill name as arguments.
</codex_skill_adapter>
