...
metadata:
  short-description: "Audit commands/ for scaffold/drift anti-patterns (Batch 24)"
---
...
Invoke this skill as `$vg-audit-scaffold`. Treat all user text after the skill name as arguments.
</codex_skill_adapter>
