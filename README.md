...
**Latest (v2.12.0):** `vgflow-repo` is the canonical source of truth for both Claude and Codex surfaces. New CRUD-SURFACES contracts make blueprint/build/review/test/accept track resource list/form/delete/security behavior across web, mobile, and backend phases.
