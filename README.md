...
**Version:** 2.32.1 · **License:** MIT

**Latest (v2.32.1):** review/test now enforce CRUD depth: per-goal runtime sequences are required, mutation goals need observed POST/PUT/PATCH/DELETE plus persistence proof, and legacy CRUD artifacts fall back to non-skipped structural tests from `CRUD-SURFACES.md`. See [CHANGELOG](CHANGELOG.md).
