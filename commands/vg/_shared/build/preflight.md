...
if [ -n "$UNKNOWN_FLAGS" ]; then
  ...
  echo "                --skip-workflow-implementation-audit,"
  echo "                --skip-edge-case-coverage-audit,"
