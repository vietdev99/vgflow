...
${PYTHON_BIN:-python3} "${VG_SCRIPT_ROOT:-${VG_HOME:-$HOME/.vgflow}/scripts}/enrich-env-question.py" \
...
"${PYTHON_BIN:-python3}" "${VG_SCRIPT_ROOT:-${VG_HOME:-$HOME/.vgflow}/scripts}/vg-orchestrator" mark-step roam 0a_enrich_env_options 2>/dev/null || true
```
