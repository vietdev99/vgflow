...
## Task 7: L2 — Evidence-based classifier (4-tier)

**Files:**
- Create: `scripts/classify-build-warning.py`
- Test: `tests/test_classify_build_warning.py`

- [ ] **Step 1: Write failing test**

Create `tests/test_classify_build_warning.py`:
...
Run: `python3 -m pytest tests/test_classify_build_warning.py -v`
Expected: 3 failures.
...
chmod +x scripts/classify-build-warning.py
python3 -m pytest tests/test_classify_build_warning.py -v
git add scripts/classify-build-warning.py tests/test_classify_build_warning.py
git commit -m "feat(build-fix-loop): add L2 evidence-based classifier (4-tier, deterministic-first)"
```
Expected: 3 passed.
